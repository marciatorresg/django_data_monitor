...
SECRET_KEY = 'django-insecure-=qzs$(5-w$@c#sc9ra$v*)&zvqp=azp)lpmjg87x@y^wx)h*74'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Añadido para templates globales
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Static files directories - CONFIGURACIÓN AÑADIDA
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
...
API_URL = 'http://mtorresg.pythonanywhere.com/landing/api/index/?format=json'
